<template>
  <el-card>
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom:10px;">
      <div>
        <el-input v-model="search" placeholder="搜索用户名/邮箱/公司/授权码" style="width:260px;margin-right:10px;" @keyup.enter="loadData"/>
...
const openDialog = () => {
  form.value = { username: '', email: '', company: '', software_name: '', hardware_id: '', expiry_days: 365 }
  if (!softwareList.value.length) loadData() // 保证弹窗打开时有软件列表
